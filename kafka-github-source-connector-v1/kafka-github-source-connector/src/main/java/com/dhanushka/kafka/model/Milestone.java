...
public class Milestone {
     ...
     */
    public Milestone(String url, String htmlUrl, String labelsUrl, Integer id, Integer number, String state, String title, String description, Creator creator, Integer openIssues, Integer closedIssues, String createdAt, String updatedAt, String closedAt, String dueOn, Map<String, Object> additionalProperties) {
        this.url = url;
