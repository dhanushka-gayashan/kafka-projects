...
public class Issue {
     ...
     */
    public Issue(Integer id, String url, String repositoryUrl, String labelsUrl, String commentsUrl, String eventsUrl, String htmlUrl, Integer number, String state, String title, String body, User user, List<Label> labels, Assignee assignee, Milestone milestone, Boolean locked, Integer comments, PullRequest pullRequest, Object closedAt, Instant createdAt, Instant updatedAt, List<Assignee> assignees, Map<String, Object> additionalProperties) {
        this.id = id;
        this.url = url;
